...
//api.use('/api',expressJwt({ secret: process.env.secret || config.secret }).unless({path: ['api/user_history.controller', 'questions.controller'],}))

//roteamento das API as devidas controllers
api.use(
  '/api/userHistory',
  require('./controllers/api/user_history.controller')
)
api.use('/api/user', require('./controllers/api/user.controller'))
api.use('/api/person', require('./controllers/api/person.controller'))
